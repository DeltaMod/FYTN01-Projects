...
for var in range(100):
    ...
    C[0] = city(C[0].N,  C[0].I, [C[0].comN[0],C[0].comN[1],C[0].comN[2]])
    C[1] = city(C[1].N,  C[1].I, [C[1].comN[0],C[1].comN[1],C[1].comN[2]])
    C[2] = city(C[2].N,  C[2].I, [C[2].comN[0],C[2].comN[1],C[2].comN[2]])
